...
export default function Homegaming1({ navigation, route, klil }) {
...
<View style={{ 
   backgroundColor: 'rgb(13, 109, 135)',
      ...
      <View style={styles.row99}>
        ...
        {trsbadinii.map((item, index) => (
          <TouchableOpacity
            key={item.id}
            onPress={() =>
              navigation.navigate('HomegamingRellsrek', {
                videos: trsbadinii,
                startIndex: index,
              })
            }
        ...
        <View style={styles.grid}>
          {data[buttons[activeIndex]]?.map(item => (
            <TouchableOpacity
              ...
              style={styles.card1}
              onPress={() =>
                navigation.navigate('Homegamingdetails', {
                  item: item,
                })
              }
            >
