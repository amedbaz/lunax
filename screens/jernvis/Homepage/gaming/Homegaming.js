...
export default function Homegaming({ navigation, route, klil }) {
...
const CardItem = ({ item }) => {
  return (
    <TouchableOpacity
      activeOpacity={0.85}
      onPress={() =>
        navigation.navigate('Homegaming1', {
          itemData: item,
        })
      }
    >
...
<View>
   {/* design */}
     <View>
        <LinearGradient
       colors={['rgb(27, 85, 14)', 'rgb(20, 47, 61)']}
       start={{ x: 0, y: 0 }}
       end={{ x: 1, y: 0 }}
       style={styles.vm}
     >
       ...
       <Image 
         source={require('../../../../assets/m907.webp')}
