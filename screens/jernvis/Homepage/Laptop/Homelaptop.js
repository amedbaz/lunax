...
export default function Homelaptop({ navigation, route, klil }) {
...
const CardItem = ({ item }) => {
  return (
    <TouchableOpacity
      activeOpacity={0.85}
      onPress={() =>
        navigation.navigate('Homelaptop1', {
          itemData: item,
        })
      }
    >
...
<View>
   {/* design */}
     <View>
        <LinearGradient
       colors={['rgb(57, 81, 14)', 'rgb(45, 102, 9)']}
       start={{ x: 0, y: 0 }}
       end={{ x: 1, y: 0 }}
       style={styles.vm}
     >
       ...
       <Image 
         source={require('../../../../assets/m200.webp')}
