...
export default function Homelaptop1({ navigation, route, klil }) {
...
<View style={{ 
 ...
 <TouchableOpacity onPress={() => navigation.goBack()}>
                     ...
                     <Text style={{ fontSize: RFPercentage(4), color: 'white', marginTop:isTablet ? wp("0%") : wp("3.5%"), textAlign: 'center',
                        fontWeight: 'bold',fontFamily: 'k24',left: isTablet ? wp("0%") : wp("4%"),
                      }}>
                       {itemData.title}
                     </Text>
                   </TouchableOpacity>
      ...
      <View style={styles.row99}>
        ...
        {trsbadinii.map((item, index) => (
          <TouchableOpacity
            key={item.id}
            onPress={() =>
              navigation.navigate('HomelaptopRellsrek', {
                videos: trsbadinii,
                startIndex: index,
              })
            }
        ...
        <View style={styles.grid}>
          {data[buttons[activeIndex]]?.map(item => (
            <TouchableOpacity
              ...
              style={styles.card1}
              onPress={() =>
                navigation.navigate('Homelaptopdetails', {
                  item: item,
                })
              }
            >
