...
export default function Homesalon1({ navigation, route, klil }) {
...
<View style={{ 
   backgroundColor: 'rgb(229, 31, 176)',
      ...
      <View style={styles.row99}>
        ...
        {trsbadinii.map((item, index) => (
          <TouchableOpacity
            key={item.id}
            onPress={() =>
              navigation.navigate('HomesalonRellsrek', {
                videos: trsbadinii,
                startIndex: index,
              })
            }
        ...
        <View style={styles.grid}>
          {data[buttons[activeIndex]]?.map(item => (
            <TouchableOpacity
              ...
              style={styles.card1}
              onPress={() =>
                navigation.navigate('Homesalondetails', {
                  item: item,
                })
              }
            >
