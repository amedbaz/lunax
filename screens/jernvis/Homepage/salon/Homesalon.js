...
export default function Homesalon({ navigation, route, klil }) {
...
const CardItem = ({ item }) => {
  return (
    <TouchableOpacity
      activeOpacity={0.85}
      onPress={() =>
        navigation.navigate('Homesalon1', {
          itemData: item,
        })
      }
    >
...
<View>
   {/* design */}
     <View>
        <LinearGradient
       colors={['rgb(126, 210, 29)', 'rgb(24, 105, 13)']}
       start={{ x: 0, y: 0 }}
       end={{ x: 1, y: 0 }}
       style={styles.vm}
     >
       ...
       <Image 
         source={require('../../../../assets/m904.png')}
