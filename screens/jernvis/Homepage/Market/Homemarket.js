...
export default function Homemarket({ navigation, route, klil }) {
...
const CardItem = ({ item }) => {
  return (
    <TouchableOpacity
      activeOpacity={0.85}
      onPress={() =>
        navigation.navigate('Homemarket1', {
          itemData: item,
        })
      }
    >
...
<View>
   {/* design */}
     <View>
        <LinearGradient
       colors={['rgb(190, 25, 10)', 'rgb(205, 78, 11)']}
       start={{ x: 0, y: 0 }}
       end={{ x: 1, y: 0 }}
       style={styles.vm}
     >
       ...
       <Image 
         source={require('../../../../assets/m24.webp')}
