...
export default function Homewatch1({ navigation, route, klil }) {
...
<View style={{ 
   backgroundColor: 'rgb(139, 118, 15)',
      ...
      <View style={styles.row99}>
        ...
        {trsbadinii.map((item, index) => (
          <TouchableOpacity
            key={item.id}
            onPress={() =>
              navigation.navigate('HomewatchRellsrek', {
                videos: trsbadinii,
                startIndex: index,
              })
            }
        ...
        <View style={styles.grid}>
          {data[buttons[activeIndex]]?.map(item => (
            <TouchableOpacity
              ...
              style={styles.card1}
              onPress={() =>
                navigation.navigate('Homewatchdetails', {
                  item: item,
                })
              }
            >
