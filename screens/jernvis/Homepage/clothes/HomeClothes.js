...
export default function HomeClothes({ navigation, route, klil }) {
...
const CardItem = ({ item }) => {
  return (
    <TouchableOpacity
      activeOpacity={0.85}
      onPress={() =>
        navigation.navigate('HomeClothes1', {
          itemData: item,
        })
      }
    >
...
<View>
   {/* design */}
     <View>
        <LinearGradient
       colors={['rgb(87, 3, 73)', 'rgb(190, 21, 228)']}
       start={{ x: 0, y: 0 }}
       end={{ x: 1, y: 0 }}
       style={styles.vm}
     >
