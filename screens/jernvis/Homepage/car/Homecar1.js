...
export default function Homecar1({ navigation, route, klil }) {
      ...
      <View style={styles.row99}>
        ...
        {trsbadinii.map((item, index) => (
          <TouchableOpacity
            key={item.id}
            onPress={() =>
              navigation.navigate('HomecarRellsrek', {
                videos: trsbadinii,
                startIndex: index,
              })
            }
        ...
        <View style={styles.grid}>
          {data[buttons[activeIndex]]?.map(item => (
            <TouchableOpacity
              ...
              style={styles.card1}
              onPress={() =>
                navigation.navigate('Homecardetails', {
                  item: item,
                })
              }
            >
